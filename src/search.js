...
function _mapPathToData(
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    if (!children) {
      throw new Error(
        `Supplied value for prop \`childrenPropertyName\`, ${childrenPropertyName}, was not found in at least one node of your data!`,
      );
    }
